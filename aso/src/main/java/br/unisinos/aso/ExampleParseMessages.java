...
public class ExampleParseMessages {
	...
	public static void main(String[] args) {
		String msg = "MSH|^~\\&|EPIC|EPICADT|SMS|SMSADT|199912271408|CHARRIS|ADT^A04|1817457|D|2.5|\r"
		...
		String real = "MSH|^~\\&|HIS|RIH|EKG|EKG|199904140038||ADT^A01||P|2.2\r"
		...
		/*
		 * The HapiContext holds all configuration and provides factory methods
		 * for obtaining all sorts of HAPI objects, e.g. parsers.
		 */
		HapiContext context = new DefaultHapiContext();

		/*
		 * A Parser is used to convert between string representations of
		 * messages and instances of HAPI's "Message" object. In this case, we
		 * are using a "GenericParser", which is able to handle both XML and ER7
		 * (pipe & hat) encodings.
		 */
		...
		/*
		 * This message was an ADT^A01 is an HL7 data type consisting of several
		 * components1, so we will cast it as such. The ADT_A01 class extends
		 * from Message, providing specialized accessors for ADT^A01's segments.
		 * 
		 * HAPI provides several versions of the ADT_A01 class, each in a
		...
		// Prints "SMITH"
		String familyName = patientName[0].getFamilyName().toString();
